...
import { BookInventoryReservationSearchInput } from '../../api/models/book-inventory-reservation-search.input';
import { BookInventoryReservationCreateInput } from '../../api/models/book-inventory-reservation-create.input';
import { BookInventoryReservationUpdateInput } from '../../api/models/book-inventory-reservation-update.input';
...
import { CustomerReservationsSearchInput } from '../../api/models/customer-reservations-search.input';
